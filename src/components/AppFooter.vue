  ...
  <footer class="footer">
    <div class="container">
      ...
      <!-- 상호 링크는 푸터에(랜딩 계획). 다른 앱으로 가는 약한 방향이라 여기 한 줄로만.
           ...
           새 앱은 뒤에 붙인다 - 나온 차례가 곧 줄의 차례다(2026-08-27, DeskNoise 추가 · 2026-09-16, MagicLoupe 추가). -->
      <p class="other">
        {{ t.footer.otherTool }} ·
        ...
        <a href="https://magicloupe.vercel.app/" target="_blank" rel="noopener">MagicLoupe</a>
      </p>
